# %% [markdown]
# ## Pipeline: Convert + Resize images & UPDATE path column
# - Đọc df['path'], convert & resize ảnh -> PNG
# - Ghi đè cột 'path' = đường dẫn PNG mới
# - Log lỗi + xuất manifest + lưu Excel mới
